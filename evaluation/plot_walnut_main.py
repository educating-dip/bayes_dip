...
add_metrics(axs[1, 2], data['psnr_mcdo'], data['ssim_mcdo'])
...
add_log_lik(axs[0, 5], data['log_lik_predcp'])
...
plot_qq(
        ...
        zorder_list=[10, 5],
        legend_kwargs={'loc': 'upper left', 'bbox_to_anchor': (0., 1.), 'prop': {'size': 'xx-small'}, 'borderpad': 0.2})
