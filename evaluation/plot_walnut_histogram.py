...
stddev = get_stddev(runs[f'include_predcp_False'], **kwargs, **stddev_kwargs)
stddev_predcp = get_stddev(runs[f'include_predcp_True'], **kwargs, **stddev_kwargs)

mask = torch.bitwise_not(torch.isnan(stddev))
